  ...
  async run() {
    ...
    switch (main_menu) {
      ...
      case 'Update Employee Role':
        ...
        const updateEmp = await Employee.select_emp();
        const updateEmpList = [];
        ...
        const updateRole = await Role.select_all_roles();
        ...
        Employee.update_emp(empName, newRole, updateEmp, updateRole);
      ...
      case 'Add Department':
        ...
        await Department.add_dept(deptName);
